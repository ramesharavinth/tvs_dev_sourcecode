...
class AppServerSvc (win32serviceutil.ServiceFramework):
    ...
    def on_message(self,chan, method_frame, _header_frame, body, userdata=None):
        ...
        val = (data['name'],'Diane1','hamster1','f','1999-03-30','1999-03-30')
    ...
    def main(self):
        ...
        parameters = pika.ConnectionParameters('mqtt-perf.symctest.com',
                                        5672,
                                        '/',
                                        credentials)
        ...
        channel.queue_bind(queue='symcSubscriptionQueue', exchange='amq.topic', routing_key='symcSubscription')
